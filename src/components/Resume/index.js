      ...
      <section className="container">
        <div className="row mb-3">
          <div className="col-md-10 mx-auto d-flex justify-content-center">
            <div>
              <a target="_blank" href="https://drive.google.com/file/d/1C9PPHpUqlApqWvdPoy7IOjx7Qaa7Tp6P/view?usp=sharing">
                <FontAwesomeIcon size="4x" className="icon"   icon={faDownload} />
              </a>
              <img
